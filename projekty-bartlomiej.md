...
| Kategoria | Narzędzie | Uwagi |
|-----------|-----------|-------|
| Wirtualizacja | Proxmox VE | |
| Storage (praca) | Synology | 6 stanowisk |
| Sieć | FortiGate, UniFi | |
| DNS/Adblock | AdGuard Home | Działa jako DNS |
...
### Środowisko
- 6 stanowisk roboczych
- Synology (storage + sync)
...
3. Nextcloud vs Synology Drive dla stanowisk
